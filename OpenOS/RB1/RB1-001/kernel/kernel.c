...
void confidential_msg() {
	...
	print_new_line();
	print_new_line();
	print_string("CONFIDENTIAL TO THE OPENOS TEAM");
	print_new_line();
	print_string("IF YOU HAVE THIS AND NOT PART OF");
	print_new_line();
	print_string("THE OPENOS TEAM THEN YOU WILL BE");
	print_new_line();
	print_string("TRACKED BY THE OPENOS TEAM.");
	print_new_line();
...
void panic(char* error_code) {
	...
	print_new_line();
	print_string("corruption and other problems.");
	print_new_line();
